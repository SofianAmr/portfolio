    ...
    >
      <Card className="flex py-4">
        <div className="flex-none">
          <Avatar className="rounded-lg size-12 m-auto">
            <AvatarImage
              src={logoUrl}
              alt={altText}
                ...
                <div className="flex flex-wrap gap-1 mt-3">
                  {technologies.map((tech, index) => (
                    <Badge
                      key={index}
                      variant="outline"
                      className="text-xs bg-foreground text-background border-foreground hover:bg-foreground/80"
                    >
                      {tech}
                    </Badge>
                  ))}
